...
public class TestDb extends AndroidTestCase {
    ...
    public long insertLocation() {
        ...
        WeatherDbHelper dbhealper = new WeatherDbHelper(mContext);
        ...
        assertFalse("Error: More than one record found", c.moveToNext());
        c.close();
        db.close();
        return rowID;
    }
    ...
    */
    ...
    public void testWeatherTable() {
        ...
        ContentValues cv = TestUtilities.createWeatherValues(rowID);
        // Insert ContentValues into database and get a row ID back
        long returnRowID = db.insert(WeatherContract.WeatherEntry.TABLE_NAME,
                                    null, cv);
        assertTrue(returnRowID!=-1);
        // Query the database and receive a Cursor back
        ...
        // Finally, close the cursor and database
        assertFalse("Error: More than onew record found", c.moveToNext());
        c.close();
        db.close();
    }
