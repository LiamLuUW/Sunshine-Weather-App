 ...
 */
package com.example.shunqi.sunshine.app.data;
...
import com.example.shunqi.sunshine.app.data.WeatherContract.LocationEntry;
import com.example.shunqi.sunshine.app.data.WeatherContract.WeatherEntry;
...
public class TestProvider extends AndroidTestCase {
   ...
   */
    ...
    // Make sure we can still delete after adding/updating stuf/// Student: Uncomment this test after you have completed writing the insert functionalit// in your provider.  It relies on insertions with testInsertReadProvider, so insert an// query functionality must also be complete before this test can be used.
    ...
    // Make sure we can still delete after adding/updating stuf/// Student: Uncomment this test after you have completed writing the delete functionalit// in your provider.  It relies on insertions with testInsertReadProvider, so insert an// query functionality must also be complete before this test can be used.
